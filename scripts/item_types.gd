...
func _init_defaults():
	item_types = [
		...
		# 电力方块 (id 42-65)
		ItemType.new(42, "Power+X", Color(1.0, 0.2, 0.1), 64, 7, 0),
		ItemType.new(43, "Power-X", Color(0.9, 0.2, 0.1), 64, 7, 1),
		ItemType.new(44, "Power+Y", Color(1.0, 0.3, 0.1), 64, 7, 2),
		ItemType.new(45, "Power-Y", Color(0.9, 0.1, 0.1), 64, 7, 3),
		ItemType.new(46, "Power+Z", Color(1.0, 0.2, 0.2), 64, 7, 4),
		ItemType.new(47, "Power-Z", Color(0.9, 0.2, 0.0), 64, 7, 5),
		ItemType.new(48, "Switch+X", Color(0.4, 0.4, 0.4), 64, 8, 0),
		ItemType.new(49, "Switch-X", Color(0.4, 0.4, 0.4), 64, 8, 1),
		ItemType.new(50, "Switch+Y", Color(0.4, 0.4, 0.4), 64, 8, 2),
		ItemType.new(51, "Switch-Y", Color(0.4, 0.4, 0.4), 64, 8, 3),
		ItemType.new(52, "Switch+Z", Color(0.4, 0.4, 0.4), 64, 8, 4),
		ItemType.new(53, "Switch-Z", Color(0.4, 0.4, 0.4), 64, 8, 5),
		ItemType.new(54, "Wire+X", Color(0.6, 0.5, 0.3), 64, 9, 0),
		ItemType.new(55, "Wire-X", Color(0.6, 0.5, 0.3), 64, 9, 1),
		ItemType.new(56, "Wire+Y", Color(0.6, 0.5, 0.3), 64, 9, 2),
		ItemType.new(57, "Wire-Y", Color(0.6, 0.5, 0.3), 64, 9, 3),
		ItemType.new(58, "Wire+Z", Color(0.6, 0.5, 0.3), 64, 9, 4),
		ItemType.new(59, "Wire-Z", Color(0.6, 0.5, 0.3), 64, 9, 5),
		ItemType.new(60, "Lamp+X", Color(0.9, 0.9, 0.8), 64, 10, 0),
		ItemType.new(61, "Lamp-X", Color(0.9, 0.9, 0.8), 64, 10, 1),
		ItemType.new(62, "Lamp+Y", Color(0.9, 0.9, 0.8), 64, 10, 2),
		ItemType.new(63, "Lamp-Y", Color(0.9, 0.9, 0.8), 64, 10, 3),
		ItemType.new(64, "Lamp+Z", Color(0.9, 0.9, 0.8), 64, 10, 4),
		ItemType.new(65, "Lamp-Z", Color(0.9, 0.9, 0.8), 64, 10, 5),
	]
